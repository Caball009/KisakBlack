...
void __userpurge pulse_sum_normal::calc_abs(pulse_sum_normal *this@<ecx>, int a2@<ebp>, const phys_vec3 *b1_r_displace)
{
    ...
    float v13; // [esp-Ch] [ebp-2Ch] BYREF
    ...
    v13 = x + b1_r_displace->x;
    v14 = this->m_b1_r.y + b1_r_displace->y;
    v15 = this->m_b1_r.z + b1_r_displace->z;
    v12.x = this->m_ud.z * v14 - v15 * this->m_ud.y;
    v12.y = v15 * this->m_ud.x - this->m_ud.z * v13;
    v12.z = v13 * this->m_ud.y - v14 * this->m_ud.x;
    v6 = phys_multiply((const phys_vec3 *)&v13, p_m_world_inv_inertia, &v12);
    this->m_b1_ap.x = v6->x;
    this->m_b1_ap.y = v6->y;
    this->m_b1_ap.z = v6->z;
    m_b1 = this->m_b1;
    v13 = this->m_b1_ap.y * this->m_b1_r.z - this->m_b1_ap.z * this->m_b1_r.y;
    v14 = this->m_b1_ap.z * this->m_b1_r.x - this->m_b1_ap.x * this->m_b1_r.z;
    v15 = this->m_b1_r.y * this->m_b1_ap.x - this->m_b1_ap.y * this->m_b1_r.x;
    v16 = this->m_ud.y * v14 + this->m_ud.x * v13 + this->m_ud.z * v15;
    v8 = v16 + m_b1->m_inv_mass;
    m_b2 = this->m_b2;
    this->m_denom = v8;
    if ( m_b2 )
    {
        v13 = this->m_b2_r.y * this->m_ud.z - this->m_b2_r.z * this->m_ud.y;
        v14 = this->m_b2_r.z * this->m_ud.x - this->m_b2_r.x * this->m_ud.z;
        v15 = this->m_ud.y * this->m_b2_r.x - this->m_b2_r.y * this->m_ud.x;
        v10 = phys_multiply(&v12, &m_b2->m_world_inv_inertia, (const phys_vec3 *)&v13);
        this->m_b2_ap.x = v10->x;
        this->m_b2_ap.y = v10->y;
        this->m_b2_ap.z = v10->z;
        v11 = this->m_b2;
        v16 = this->m_b2_ap.y * v14 + this->m_b2_ap.x * v13 + this->m_b2_ap.z * v15;
        this->m_denom = v16 + v11->m_inv_mass + this->m_denom;
    }
...
LABEL_19:
    ...
    if ( m_node )
    {
        ...
        else
        {
            ...
            pulse_sum_normal::set_object_vel(this, v15);
            v19.x = b2_r->x + b2->m_mat.w.x;
            v19.y = b2->m_mat.w.y + b2_r->y;
            v19.z = b2->m_mat.w.z + b2_r->z;
            pulse_sum_normal::set_object_col_pt(this, &v19);
        }
        this->m_ud.x = ud->x;
        this->m_ud.y = ud->y;
        z = ud->z;
    ...
    else
    {
        ...
        pulse_sum_normal::set_object_vel(this, v17);
        v18 = this->m_b2 == 0;
    ...
    this->m_flags = 0;
    pulse_sum_normal::calc_abs(this, (int)v20, b1_r_displace);
}
...
LABEL_19:
    ...
    if ( m_node )
    {
        ...
        {
            this->m_b2 = 0;
            pulse_sum_angular::set_object_vel(this, &b2->m_a_vel);
            pulse_sum_angular::set_object_col_pt(this, b2_r);
        }
        this->m_ud.x = ud->x;
        this->m_ud.y = ud->y;
        z = ud->z;
    ...
    else
    {
        ...
        this->m_b1_r.z = b2_r->z;
        this->m_b2 = 0;
        pulse_sum_angular::set_object_vel(this, &v9->m_a_vel);
        pulse_sum_angular::set_object_col_pt(this, b1_r);
        v15 = -ud->x;
        v16 = -ud->y;
        v17 = -ud->z;
        this->m_ud.x = v15;
    ...
    this->m_pulse_sum_cache = ps_cache;
    this->m_flags = 0;
    pulse_sum_angular::calc_abs(this, (int)v18);
}
                ...
                float damp_k)
{
    ...
    else
    {
        ...
        pulse_sum_point::set_object_vel(this, v16);
        v17 = this->m_b2 == 0;
    ...
    this->m_b2_r.z = z;
    this->m_pulse_sum_cache = ps_cache;
    pulse_sum_point::calc_abs_and_setup(this, (int)v19, delta_t, is_spring, spring_k, damp_k);
}
                ...
                float delta_t)
{
    ...
    float x; // [esp+54h] [ebp-3Ch] BYREF
    float v32; // [esp+58h] [ebp-38h]
    float v33; // [esp+5Ch] [ebp-34h]
    phys_vec3 b2_r; // [esp+60h] [ebp-30h]
    const phys_mat44 *p_m_mat; // [esp+70h] [ebp-20h]
    float v36; // [esp+74h] [ebp-1Ch]
    float min_restitution_impact_vel_sq; // [esp+78h] [ebp-18h]
    const phys_vec3 *v38; // [esp+7Ch] [ebp-14h]
    int pp_i; // [esp+80h] [ebp-10h]
    phys_vec3 *b2_r_loc; // [esp+84h] [ebp-Ch] BYREF
    phys_vec3 *b1_r_loc; // [esp+88h] [ebp-8h]
    phys_vec3 *retaddr; // [esp+90h] [ebp+0h]
...
LABEL_15:
    ...
    this->m_ud_f1.y = v9->y;
    this->m_ud_f1.z = v9->z;
    x = this->m_ud_n.y * this->m_ud_f1.z - this->m_ud_n.z * this->m_ud_f1.y;
    v32 = this->m_ud_f1.x * this->m_ud_n.z - this->m_ud_n.x * this->m_ud_f1.z;
    v33 = this->m_ud_n.x * this->m_ud_f1.y - this->m_ud_n.y * this->m_ud_f1.x;
    this->m_ud_f2.x = x;
    this->m_ud_f2.y = v32;
    this->m_ud_f2.z = v33;
    ...
    v38 = m_list_b1_r_loc;
    LODWORD(min_restitution_impact_vel_sq) = m_list_b2_r_loc;
    v36 = v15 * v15 + x * x + v16 * v16;
    v20 = v36;
    v36 = 0.0;
    ...
    if ( !v19 )
    {
        ...
        do
        {
            v21 = &this->m_list_pscp[pp_i / 0xD0u];
            phys_multiply(&v27, p_m_mat, v38);
            v22 = min_restitution_impact_vel_sq;
            v21->m_b1_r.x = v27.x;
            v21->m_b1_r.y = v27.y;
            v21->m_b1_r.z = v27.z;
            phys_multiply((const phys_vec3 *)&x, &b2->m_mat, (const phys_vec3 *)LODWORD(v22));
            if ( this->m_b2 )
            {
                v21->m_b2_r.x = x;
                v21->m_b2_r.y = v32;
            ...
            {
                v24 = rbint::gtv(&v26, b2, (const phys_vec3 *)&x);
                v21->m_b2_ap_n.x = v24->x;
                v21->m_b2_ap_n.y = v24->y;
                v21->m_b2_ap_n.z = v24->z;
                v25 = this->m_b2 == 0;
                v28 = x + b2->m_mat.w.x;
                v29 = b2->m_mat.w.y + v32;
                v30 = b2->m_mat.w.z + v33;
                if ( !v25 )
                {
                    if ( _tlAssert(
                                 "c:\\projects_pc\\cod\\codsrc\\tl\\physics\\include\\constraint_solver\\pulse_sum_contact_inline.h",
            ...
            v21->m_b2_r.z = v23;
            pulse_sum_contact_point::calc_abs(v21, (int)&b2_r_loc, this);
            ...
            v19 = ++LODWORD(v36) < cpi->m_point_pair_count;
        }
        while ( v19 );
    }
}
                ...
                float outside_delta_t)
{
    ...
    if ( m_list_island_count > 0 )
    {
        ...
        *(unsigned int *)v5 = m_list_island;
        *((unsigned int *)v5 + 1) = m_list_island_count;
        *((unsigned int *)v5 + 2) = &g_list_island_cur;
                ...
                rigid_body_constraint *rbc)
{
    ...
    if ( rbc->b1 && (rbc->b1->m_flags & 0x20) != 0 || (b2 = rbc->b2, p_b1 = &rbc->b2, b2) && (b2->m_flags & 0x20) != 0 )
    {
        if ( p_b1 )
        {
            v7 = phys_inplace_avl_tree<user_rigid_body *,pulse_sum_constraint_solver::temp_user_rigid_body,pulse_sum_constraint_solver::temp_user_rigid_body::avl_tree_accessor>::find(
                         turb_search_tree,
                         (user_rigid_body **)p_b1);
            if ( !v7 )
            {
                v7 = (pulse_sum_constraint_solver::temp_user_rigid_body *)phys_transient_allocator::allocate(
            ...
            v8 = (pulse_sum_constraint_solver::user_rigid_body_restore_info *)phys_transient_allocator::allocate(
                                                                                                                                                    &this->m_solver_memory_allocator,
                                                                                                                                                    12,
                                                                                                                                                    4,
                                                                                                                                                    0,
...
int __cdecl phys_jq_constraint_solver_batch_function(jqBatch *pBatch)
{
    ...
    v4 = (volatile signed __int32 *)*((unsigned int *)Input + 2);
    v8 = 0;
    for ( i = _InterlockedExchangeAdd(v4, 1u);
                i < *((unsigned int *)Input + 1);
                i = _InterlockedExchangeAdd(*((volatile signed __int32 **)Input + 2), 1u) )
    {
                ...
                const bool add_error)
{
    ...
    m_objective = pulse_sum_normal::get_objective(this) + this->m_cfm * this->m_pulse_sum - this->m_right_side;
    m_last_pulse_sum = this->m_pulse_sum;
    m_objective = this->m_pulse_sum - m_objective / this->m_denom;
    m_objective = pulse_sum_normal::clamp_pulse_sum(this, m_objective);
    v4 = m_objective;
    ...
    pulse_sum_normal::apply(this, &m_objective);
    if ( add_error )
    {
...
void __thiscall pulse_sum_normal::SOLVER_solver_prolog(pulse_sum_normal *this, float delta_t)
{
    ...
    vel = pulse_sum_normal::get_vel(this, (int)&savedregs);
    ...
    this->m_pulse_sum = pulse_sum_normal::clamp_pulse_sum(v5, delta_ta);
...
void __userpurge pulse_sum_point::SOLVER_apply_relaxation(pulse_sum_point *this@<ecx>, int a2@<ebp>, float *error_sq)
{
    ...
    float v19; // [esp+14h] [ebp-3Ch] BYREF
    float v20; // [esp+18h] [ebp-38h]
    float v21; // [esp+1Ch] [ebp-34h]
    ...
    v26 = retaddr;
    m_cfm = this->m_cfm;
    v19 = this->m_pulse_sum.x * m_cfm;
    v20 = this->m_pulse_sum.y * m_cfm;
    v21 = m_cfm * this->m_pulse_sum.z;
    objective = pulse_sum_point::get_objective(this, &v14);
    x = this->m_pulse_sum.x;
    y = this->m_pulse_sum.y;
    m_objective.y = objective->x + v19;
    m_objective.z = objective->y + v20;
    z = objective->z;
    ...
    v11 = m_objective.z;
    m_objective.z = y;
    v20 = v11 - this->m_right_side.y;
    w = m_objective.w;
    m_objective.w = v8;
    v21 = w - this->m_right_side.z;
    v14.x = v21 * this->m_cr12.x;
    v14.y = this->m_cr12.y * v21;
    v14.z = v21 * this->m_cr12.z;
    error_.y = this->m_cr31.x * v20;
    error_.z = this->m_cr31.y * v20;
    error_.w = v20 * this->m_cr31.z;
    v13 = v19;
    v19 = v19 * this->m_cr23.x;
    v20 = this->m_cr23.y * v13;
    v21 = v13 * this->m_cr23.z;
    v15 = v19 + error_.y;
    v16 = v20 + error_.z;
    v17 = v21 + error_.w;
    error_.y = v15 + v14.x;
    ...
    v19 = this->m_pulse_sum.x - m_objective.y;
    v20 = this->m_pulse_sum.y - m_objective.z;
    v21 = this->m_pulse_sum.z - m_objective.w;
    pulse_sum_point::apply(this, (const phys_vec3 *)&v19);
    v14.x = this->m_denom.x * v19;
    v14.y = this->m_denom.y * v20;
    v14.z = this->m_denom.z * v21;
    v15 = v14.x * v14.x;
    v16 = v14.y * v14.y;
    v17 = v14.z * v14.z;
...
void __thiscall pulse_sum_angular::SOLVER_apply_relaxation(pulse_sum_angular *this, float *error_sq)
{
    ...
    error_sq___ = pulse_sum_angular::get_objective(this) + this->m_cfm * this->m_pulse_sum - this->m_right_side;
    m_last_pulse_sum = this->m_pulse_sum;
    error_sq___ = this->m_pulse_sum - error_sq___ / this->m_denom;
    error_sq___ = pulse_sum_angular::clamp_pulse_sum(this, error_sq___);
    v3 = error_sq___;
    ...
    pulse_sum_angular::apply(this, &error_sq___);
                ...
                pulse_sum_contact *psc)
{
    ...
    float v31; // [esp-Ch] [ebp-4Ch] BYREF
    float v32; // [esp-8h] [ebp-48h]
    float v33; // [esp-4h] [ebp-44h]
    phys_vec3 b2_t_f2; // [esp+0h] [ebp-40h] BYREF
    phys_vec3 b2_t_f1; // [esp+10h] [ebp-30h] BYREF
    ...
    b2_t_f2.y = psc->m_ud_n.z * this->m_b1_r.y - psc->m_ud_n.y * this->m_b1_r.z;
    b2_t_f2.z = this->m_b1_r.z * psc->m_ud_n.x - psc->m_ud_n.z * this->m_b1_r.x;
    b2_t_f2.w = psc->m_ud_n.y * this->m_b1_r.x - this->m_b1_r.y * psc->m_ud_n.x;
    v5 = phys_multiply((const phys_vec3 *)&v31, p_m_world_inv_inertia, (phys_vec3 *)&b2_t_f2.y);
    this->m_b1_ap_n.x = v5->x;
    this->m_b1_ap_n.y = v5->y;
    this->m_b1_ap_n.z = v5->z;
    m_b1 = psc->m_b1;
    b2_t_n.w = this->m_b1_ap_n.y * b2_t_f2.z + this->m_b1_ap_n.x * b2_t_f2.y + this->m_b1_ap_n.z * b2_t_f2.w;
    this->m_denom_xx = b2_t_n.w + m_b1->m_inv_mass;
    v27 = &psc->m_b1->m_world_inv_inertia;
    b2_t_f1.y = psc->m_ud_f1.z * this->m_b1_r.y - psc->m_ud_f1.y * this->m_b1_r.z;
    b2_t_f1.z = psc->m_ud_f1.x * this->m_b1_r.z - psc->m_ud_f1.z * this->m_b1_r.x;
    b2_t_f1.w = psc->m_ud_f1.y * this->m_b1_r.x - psc->m_ud_f1.x * this->m_b1_r.y;
    v7 = phys_multiply((const phys_vec3 *)&v31, v27, (phys_vec3 *)&b2_t_f1.y);
    this->m_b1_ap_f1.x = v7->x;
    this->m_b1_ap_f1.y = v7->y;
    this->m_b1_ap_f1.z = v7->z;
    v8 = psc->m_b1;
    b2_t_n.w = this->m_b1_ap_f1.y * b2_t_f1.z + this->m_b1_ap_f1.x * b2_t_f1.y + this->m_b1_ap_f1.z * b2_t_f1.w;
    this->m_denom_yy = b2_t_n.w + v8->m_inv_mass;
    v25 = &psc->m_b1->m_world_inv_inertia;
    v31 = psc->m_ud_f2.z * this->m_b1_r.y - this->m_b1_r.z * psc->m_ud_f2.y;
    v32 = psc->m_ud_f2.x * this->m_b1_r.z - psc->m_ud_f2.z * this->m_b1_r.x;
    v33 = this->m_b1_r.x * psc->m_ud_f2.y - psc->m_ud_f2.x * this->m_b1_r.y;
    v9 = phys_multiply(&v30, v25, (const phys_vec3 *)&v31);
    this->m_b1_ap_f2.x = v9->x;
    this->m_b1_ap_f2.y = v9->y;
    this->m_b1_ap_f2.z = v9->z;
    v10 = psc->m_b1;
    b2_t_n.w = this->m_b1_ap_f2.y * v32 + this->m_b1_ap_f2.x * v31 + this->m_b1_ap_f2.z * v33;
    this->m_denom_zz = b2_t_n.w + v10->m_inv_mass;
    v37 = this->m_b1_ap_f2.y * b2_t_f1.z + this->m_b1_ap_f2.x * b2_t_f1.y + this->m_b1_ap_f2.z * b2_t_f1.w;
    z = b2_t_f2.z;
    y = b2_t_f2.y;
    w = b2_t_f2.w;
    this->m_denom_xy = this->m_b1_ap_f1.z * b2_t_f2.w + this->m_b1_ap_f1.x * b2_t_f2.y + this->m_b1_ap_f1.y * b2_t_f2.z;
    this->m_denom_xz = y * this->m_b1_ap_f2.x + z * this->m_b1_ap_f2.y + w * this->m_b1_ap_f2.z;
    m_b2 = psc->m_b2;
    if ( m_b2 )
    {
        b2_t_f1.y = this->m_b2_r.y * psc->m_ud_n.z - this->m_b2_r.z * psc->m_ud_n.y;
        b2_t_f1.z = this->m_b2_r.z * psc->m_ud_n.x - this->m_b2_r.x * psc->m_ud_n.z;
        b2_t_f1.w = psc->m_ud_n.y * this->m_b2_r.x - psc->m_ud_n.x * this->m_b2_r.y;
        v15 = phys_multiply(&v30, &m_b2->m_world_inv_inertia, (phys_vec3 *)&b2_t_f1.y);
        this->m_b2_ap_n.x = v15->x;
        this->m_b2_ap_n.y = v15->y;
        this->m_b2_ap_n.z = v15->z;
        v16 = psc->m_b2;
        b2_t_n.w = this->m_b2_ap_n.y * b2_t_f1.z + this->m_b2_ap_n.x * b2_t_f1.y + this->m_b2_ap_n.z * b2_t_f1.w;
        this->m_denom_xx = b2_t_n.w + v16->m_inv_mass + this->m_denom_xx;
        v28 = &psc->m_b2->m_world_inv_inertia;
        b2_t_f2.y = this->m_b2_r.y * psc->m_ud_f1.z - this->m_b2_r.z * psc->m_ud_f1.y;
        b2_t_f2.z = psc->m_ud_f1.x * this->m_b2_r.z - this->m_b2_r.x * psc->m_ud_f1.z;
        b2_t_f2.w = this->m_b2_r.x * psc->m_ud_f1.y - this->m_b2_r.y * psc->m_ud_f1.x;
        v17 = phys_multiply(&v30, v28, (phys_vec3 *)&b2_t_f2.y);
        this->m_b2_ap_f1.x = v17->x;
        this->m_b2_ap_f1.y = v17->y;
        this->m_b2_ap_f1.z = v17->z;
        v18 = psc->m_b2;
        b2_t_n.w = this->m_b2_ap_f1.y * b2_t_f2.z + this->m_b2_ap_f1.x * b2_t_f2.y + this->m_b2_ap_f1.z * b2_t_f2.w;
        this->m_denom_yy = b2_t_n.w + v18->m_inv_mass + this->m_denom_yy;
        v26 = &psc->m_b2->m_world_inv_inertia;
        v31 = this->m_b2_r.y * psc->m_ud_f2.z - this->m_b2_r.z * psc->m_ud_f2.y;
        v32 = psc->m_ud_f2.x * this->m_b2_r.z - psc->m_ud_f2.z * this->m_b2_r.x;
        v33 = psc->m_ud_f2.y * this->m_b2_r.x - psc->m_ud_f2.x * this->m_b2_r.y;
        v19 = phys_multiply(&v30, v26, (const phys_vec3 *)&v31);
        this->m_b2_ap_f2.x = v19->x;
        this->m_b2_ap_f2.y = v19->y;
        this->m_b2_ap_f2.z = v19->z;
        v20 = psc->m_b2;
        b2_t_n.w = this->m_b2_ap_f2.y * v32 + v31 * this->m_b2_ap_f2.x + this->m_b2_ap_f2.z * v33;
        this->m_denom_zz = b2_t_n.w + v20->m_inv_mass + this->m_denom_zz;
        b2_t_n.w = this->m_b2_ap_f2.y * b2_t_f2.z + b2_t_f2.y * this->m_b2_ap_f2.x + this->m_b2_ap_f2.z * b2_t_f2.w;
        v37 = b2_t_n.w + v37;
        v21 = b2_t_f1.z;
        v22 = b2_t_f1.y;
        v23 = b2_t_f1.w;
        b2_t_n.w = this->m_b2_ap_f1.z * b2_t_f1.w + this->m_b2_ap_f1.x * b2_t_f1.y + this->m_b2_ap_f1.y * b2_t_f1.z;
        this->m_denom_xy = b2_t_n.w + this->m_denom_xy;
        b2_t_n.w = v22 * this->m_b2_ap_f2.x + v21 * this->m_b2_ap_f2.y + v23 * this->m_b2_ap_f2.z;
        this->m_denom_xz = b2_t_n.w + this->m_denom_xz;
    }
    b2_t_n.w = this->m_denom_zz * this->m_denom_yy - v37 * v37;
    if ( b2_t_n.w <= 0.0
        && _tlAssert(
                 "c:\\projects_pc\\cod\\codsrc\\tl\\physics\\include\\constraint_solver\\pulse_sum_contact_inline.h",
                 38,
    ...
    v24 = b2_t_n.w;
    this->m_inv_yy = b2_t_n.w * this->m_denom_zz;
    this->m_inv_yz = -v37 * v24;
...
void    rbint::euler_integrate_velocity(float a1@<ebp>, rigid_body *const rb, float delta_t)
{
    ...
    double v13; // st7
    double v14; // st7
    float v15; // [esp+14h] [ebp-3Ch] BYREF
    float v16; // [esp+18h] [ebp-38h]
    float v17; // [esp+1Ch] [ebp-34h]
    _BYTE a_vel_loc2_4[28]; // [esp+24h] [ebp-2Ch] OVERLAPPED BYREF
    float m_inv_mass; // [esp+40h] [ebp-10h]
    float factor; // [esp+44h] [ebp-Ch] BYREF
    float ake_times_two_2; // [esp+48h] [ebp-8h]
    float retaddr; // [esp+50h] [ebp+0h]

    factor = a1;
    ake_times_two_2 = retaddr;
    v3 = 100000.0;
    m_inv_mass = fabs(rb->m_t_vel.x);
    if ( m_inv_mass > 100000.0
        || (m_inv_mass = fabs(rb->m_t_vel.y), m_inv_mass > 100000.0)
        || (m_inv_mass = fabs(rb->m_t_vel.z), m_inv_mass > 100000.0) )
    {
        phys_exec_debug_callback(rb);
        v3 = 100000.0;
    }
    m_inv_mass = fabs(rb->m_a_vel.x);
    if ( m_inv_mass > v3
        || (m_inv_mass = fabs(rb->m_a_vel.y), m_inv_mass > v3)
        || (m_inv_mass = fabs(rb->m_a_vel.z), v3 < m_inv_mass) )
    {
        phys_exec_debug_callback(rb);
    }
    ...
    m_inv_mass = rb->m_inv_mass;
    *(float *)a_vel_loc2_4 = m_inv_mass * rb->m_force_sum.x;
    *(float *)&a_vel_loc2_4[4] = rb->m_force_sum.y * m_inv_mass;
    *(float *)&a_vel_loc2_4[8] = m_inv_mass * rb->m_force_sum.z;
    v15 = *(float *)a_vel_loc2_4 + rb->m_gravity_acc_vec.x;
    v16 = rb->m_gravity_acc_vec.y + *(float *)&a_vel_loc2_4[4];
    v17 = rb->m_gravity_acc_vec.z + *(float *)&a_vel_loc2_4[8];
    *(float *)a_vel_loc2_4 = v15 * delta_t;
    *(float *)&a_vel_loc2_4[4] = v16 * delta_t;
    *(float *)&a_vel_loc2_4[8] = v17 * delta_t;
    rb->m_t_vel.x = rb->m_t_vel.x + *(float *)a_vel_loc2_4;
    rb->m_t_vel.y = rb->m_t_vel.y + *(float *)&a_vel_loc2_4[4];
    rb->m_t_vel.z = *(float *)&a_vel_loc2_4[8] + rb->m_t_vel.z;
    v4 = rbint::inv_L((int)&factor, (const phys_vec3 *)&v15, rb, &rb->m_torque_sum, delta_t);
    rb->m_a_vel.x = rb->m_a_vel.x + v4->x;
    rb->m_a_vel.y = v4->y + rb->m_a_vel.y;
    rb->m_a_vel.z = v4->z + rb->m_a_vel.z;
    v15 = rb->m_mat.x.y * rb->m_a_vel.y + rb->m_a_vel.x * rb->m_mat.x.x + rb->m_mat.x.z * rb->m_a_vel.z;
    v16 = rb->m_mat.y.y * rb->m_a_vel.y + rb->m_a_vel.x * rb->m_mat.y.x + rb->m_mat.y.z * rb->m_a_vel.z;
    v17 = rb->m_mat.z.y * rb->m_a_vel.y + rb->m_a_vel.x * rb->m_mat.z.x + rb->m_mat.z.z * rb->m_a_vel.z;
    v5 = v15;
    *(float *)a_vel_loc2_4 = v15 / rb->m_inv_inertia.x;
    v6 = v16;
    *(float *)&a_vel_loc2_4[4] = v16 / rb->m_inv_inertia.y;
    *(float *)&a_vel_loc2_4[8] = v17 / rb->m_inv_inertia.z;
    *(float *)&a_vel_loc2_4[20] = *(float *)&a_vel_loc2_4[4] * v16
                                                            + *(float *)a_vel_loc2_4 * v15
                                                            + *(float *)&a_vel_loc2_4[8] * v17;
    v15 = *(float *)&a_vel_loc2_4[4] * v17 - *(float *)&a_vel_loc2_4[8] * v16;
    v16 = *(float *)&a_vel_loc2_4[8] * v5 - v17 * *(float *)a_vel_loc2_4;
    v17 = *(float *)a_vel_loc2_4 * v6 - v5 * *(float *)&a_vel_loc2_4[4];
    *(float *)a_vel_loc2_4 = rb->m_inv_inertia.x * v15;
    *(float *)&a_vel_loc2_4[4] = rb->m_inv_inertia.y * v16;
    *(float *)&a_vel_loc2_4[8] = rb->m_inv_inertia.z * v17;
    v15 = *(float *)a_vel_loc2_4 * delta_t;
    v16 = *(float *)&a_vel_loc2_4[4] * delta_t;
    v17 = delta_t * *(float *)&a_vel_loc2_4[8];
    v7 = phys_multiply((const phys_vec3 *)a_vel_loc2_4, &rb->m_mat, (const phys_vec3 *)&v15);
    rb->m_a_vel.x = v7->x + rb->m_a_vel.x;
    rb->m_a_vel.y = v7->y + rb->m_a_vel.y;
    rb->m_a_vel.z = v7->z + rb->m_a_vel.z;
    m_inv_mass = rb->m_a_vel.y * rb->m_a_vel.y + rb->m_a_vel.x * rb->m_a_vel.x + rb->m_a_vel.z * rb->m_a_vel.z;
    *(float *)&a_vel_loc2_4[24] = rb->m_max_avel;
    *(float *)&a_vel_loc2_4[24] = *(float *)&a_vel_loc2_4[24] * *(float *)&a_vel_loc2_4[24];
    if ( *(float *)&a_vel_loc2_4[24] < (double)m_inv_mass )
    {
        if ( m_inv_mass <= 9.999999439624929e-11
            && _tlAssert(
        ...
        *(double *)&a_vel_loc2_4[8] = rb->m_max_avel;
        *(float *)&a_vel_loc2_4[24] = sqrt(m_inv_mass);
        *(float *)&a_vel_loc2_4[24] = *(double *)&a_vel_loc2_4[8] / *(float *)&a_vel_loc2_4[24];
        v8 = *(float *)&a_vel_loc2_4[24];
        rb->m_a_vel.x = *(float *)&a_vel_loc2_4[24] * rb->m_a_vel.x;
        rb->m_a_vel.y = v8 * rb->m_a_vel.y;
        rb->m_a_vel.z = v8 * rb->m_a_vel.z;
    }
    v15 = rb->m_mat.x.y * rb->m_a_vel.y + rb->m_mat.x.x * rb->m_a_vel.x + rb->m_mat.x.z * rb->m_a_vel.z;
    v16 = rb->m_mat.y.y * rb->m_a_vel.y + rb->m_mat.y.x * rb->m_a_vel.x + rb->m_mat.y.z * rb->m_a_vel.z;
    v17 = rb->m_mat.z.y * rb->m_a_vel.y + rb->m_mat.z.x * rb->m_a_vel.x + rb->m_mat.z.z * rb->m_a_vel.z;
    *(float *)a_vel_loc2_4 = v15 / rb->m_inv_inertia.x;
    *(float *)&a_vel_loc2_4[4] = v16 / rb->m_inv_inertia.y;
    *(float *)&a_vel_loc2_4[8] = v17 / rb->m_inv_inertia.z;
    *(float *)&a_vel_loc2_4[24] = v15 * *(float *)a_vel_loc2_4
                                                            + v16 * *(float *)&a_vel_loc2_4[4]
                                                            + v17 * *(float *)&a_vel_loc2_4[8];
    v9 = *(float *)&a_vel_loc2_4[24];
    if ( *(float *)&a_vel_loc2_4[20] < (double)*(float *)&a_vel_loc2_4[24] && v9 > 0.0000099999997 )
    {
        *(float *)&a_vel_loc2_4[20] = *(float *)&a_vel_loc2_4[20] / v9;
        *(float *)&a_vel_loc2_4[20] = sqrt(*(float *)&a_vel_loc2_4[20]);
        v10 = *(float *)&a_vel_loc2_4[20];
        rb->m_a_vel.x = rb->m_a_vel.x * *(float *)&a_vel_loc2_4[20];
        rb->m_a_vel.y = rb->m_a_vel.y * v10;
        rb->m_a_vel.z = v10 * rb->m_a_vel.z;
    }
    *(float *)&a_vel_loc2_4[20] = rb->m_t_drag_coef * delta_t;
    if ( *(float *)&a_vel_loc2_4[20] >= 0.8999999761581421 )
    {
        m_inv_mass = 0.89999998;
        v11 = 0.89999998;
    }
    else
    {
        v11 = 0.89999998;
        m_inv_mass = *(float *)&a_vel_loc2_4[20];
    }
    *(float *)&a_vel_loc2_4[20] = 1.0 - m_inv_mass;
    v12 = *(float *)&a_vel_loc2_4[20];
    rb->m_t_vel.x = rb->m_t_vel.x * *(float *)&a_vel_loc2_4[20];
    rb->m_t_vel.y = rb->m_t_vel.y * v12;
    rb->m_t_vel.z = v12 * rb->m_t_vel.z;
    *(float *)&a_vel_loc2_4[20] = delta_t * rb->m_a_drag_coef;
    if ( *(float *)&a_vel_loc2_4[20] < 0.8999999761581421 )
        v11 = *(float *)&a_vel_loc2_4[20];
    m_inv_mass = v11;
    *(float *)&a_vel_loc2_4[20] = 1.0 - m_inv_mass;
    v13 = *(float *)&a_vel_loc2_4[20];
    rb->m_a_vel.x = *(float *)&a_vel_loc2_4[20] * rb->m_a_vel.x;
    rb->m_a_vel.y = v13 * rb->m_a_vel.y;
    rb->m_a_vel.z = v13 * rb->m_a_vel.z;
    *(float *)&a_vel_loc2_4[20] = fabs(rb->m_t_vel.x);
    v14 = 100000.0;
    if ( *(float *)&a_vel_loc2_4[20] > 100000.0
        || (*(float *)&a_vel_loc2_4[20] = fabs(rb->m_t_vel.y), *(float *)&a_vel_loc2_4[20] > 100000.0)
        || (*(float *)&a_vel_loc2_4[20] = fabs(rb->m_t_vel.z), *(float *)&a_vel_loc2_4[20] > 100000.0) )
    {
        phys_exec_debug_callback(rb);
        v14 = 100000.0;
    }
    *(float *)&a_vel_loc2_4[20] = fabs(rb->m_a_vel.x);
    if ( *(float *)&a_vel_loc2_4[20] > v14
        || (*(float *)&a_vel_loc2_4[20] = fabs(rb->m_a_vel.y), *(float *)&a_vel_loc2_4[20] > v14)
        || (*(float *)&a_vel_loc2_4[20] = fabs(rb->m_a_vel.z), v14 < *(float *)&a_vel_loc2_4[20]) )
    {
        phys_exec_debug_callback(rb);
    }
}
...
{
    _BYTE v3[12]; // [esp+18h] [ebp-6Ch] BYREF
    phys_mat44 rv; // [esp+24h] [ebp-60h]
    float v5; // [esp+74h] [ebp-10h]
    unsigned int v6[3]; // [esp+78h] [ebp-Ch] BYREF
    ...
    rb->m_mat.w.y = rb->m_mat.w.y + rv.w.z;
    rb->m_mat.w.z = rb->m_mat.w.z + rv.w.w;
    make_rotate((int)v6, (phys_mat44 *)v3, &rb->m_a_vel, delta_t, 1000.0);
    phys_multiply_mat((int)v6, &rb->m_mat, (const phys_mat44 *)v3, &rb->m_mat);
    if ( ++rb->m_tick > 5 )
    {
        rb->m_tick = 0;
        orthonormalize(&rb->m_mat);
    }
    v5 = fabs(rb->m_mat.w.x);
    if ( v5 > 100000.0 || (v5 = fabs(rb->m_mat.w.y), v5 > 100000.0) || (v5 = fabs(rb->m_mat.w.z), v5 > 100000.0) )
        phys_exec_debug_callback(rb);
}
                ...
                float damp_k)
{
    ...
    double y; // st3
    double v26; // st7
    float v27[3]; // [esp-Ch] [ebp-6Ch] BYREF
    phys_vec3 pos; // [esp+0h] [ebp-60h] BYREF
    ...
    pos.z = this->m_b1_r.z;
    pos.w = -this->m_b1_r.y;
    v9 = phys_multiply((const phys_vec3 *)v27, &m_b1->m_world_inv_inertia, (phys_vec3 *)&pos.y);
    this->m_b1_apx.x = v9->x;
    this->m_b1_apx.y = v9->y;
    this->m_b1_apx.z = v9->z;
    zy.y = this->m_b1_apx.y * this->m_b1_r.z - this->m_b1_apx.z * this->m_b1_r.y;
    zy.z = this->m_b1_r.x * this->m_b1_apx.z - this->m_b1_apx.x * this->m_b1_r.z;
    zy.w = this->m_b1_apx.x * this->m_b1_r.y - this->m_b1_r.x * this->m_b1_apx.y;
    zy.y = zy.y + m_inv_mass;
    pos.y = -this->m_b1_r.z;
    pos.z = 0.0;
    pos.w = this->m_b1_r.x;
    v10 = phys_multiply((const phys_vec3 *)v27, p_m_world_inv_inertia, (phys_vec3 *)&pos.y);
    this->m_b1_apy.x = v10->x;
    this->m_b1_apy.y = v10->y;
    this->m_b1_apy.z = v10->z;
    zz.y = this->m_b1_apy.y * this->m_b1_r.z - this->m_b1_apy.z * this->m_b1_r.y;
    zz.z = this->m_b1_apy.z * this->m_b1_r.x - this->m_b1_r.z * this->m_b1_apy.x;
    zz.w = this->m_b1_apy.x * this->m_b1_r.y - this->m_b1_apy.y * this->m_b1_r.x;
    zz.z = zz.z + m_inv_mass;
    pos.y = this->m_b1_r.y;
    pos.z = -this->m_b1_r.x;
    pos.w = 0.0;
    v11 = phys_multiply((const phys_vec3 *)v27, p_m_world_inv_inertia, (phys_vec3 *)&pos.y);
    this->m_b1_apz.x = v11->x;
    this->m_b1_apz.y = v11->y;
    this->m_b1_apz.z = v11->z;
    m_b2 = this->m_b2;
    v29 = this->m_b1_apz.y * this->m_b1_r.z - this->m_b1_apz.z * this->m_b1_r.y;
    v30 = this->m_b1_apz.z * this->m_b1_r.x - this->m_b1_apz.x * this->m_b1_r.z;
    zx.w = this->m_b1_apz.x * this->m_b1_r.y - this->m_b1_r.x * this->m_b1_apz.y;
    v31 = zx.w + m_inv_mass;
    if ( m_b2 )
    {
        ...
        pos.z = this->m_b2_r.z;
        pos.w = -this->m_b2_r.y;
        v14 = phys_multiply((const phys_vec3 *)v27, &m_b2->m_world_inv_inertia, (phys_vec3 *)&pos.y);
        this->m_b2_apx.x = v14->x;
        this->m_b2_apx.y = v14->y;
        this->m_b2_apx.z = v14->z;
        pos.y = this->m_b2_apx.y * this->m_b2_r.z - this->m_b2_apx.z * this->m_b2_r.y;
        pos.z = this->m_b2_apx.z * this->m_b2_r.x - this->m_b2_apx.x * this->m_b2_r.z;
        pos.w = this->m_b2_r.y * this->m_b2_apx.x - this->m_b2_apx.y * this->m_b2_r.x;
        zy.y = pos.y + zy.y;
        zy.z = pos.z + zy.z;
        zy.w = pos.w + zy.w;
        zy.y = m_inv_mass + zy.y;
        pos.y = -this->m_b2_r.z;
        pos.z = 0.0;
        pos.w = this->m_b2_r.x;
        v15 = phys_multiply((const phys_vec3 *)v27, v13, (phys_vec3 *)&pos.y);
        this->m_b2_apy.x = v15->x;
        this->m_b2_apy.y = v15->y;
        this->m_b2_apy.z = v15->z;
        pos.y = this->m_b2_apy.y * this->m_b2_r.z - this->m_b2_apy.z * this->m_b2_r.y;
        pos.z = this->m_b2_apy.z * this->m_b2_r.x - this->m_b2_r.z * this->m_b2_apy.x;
        pos.w = this->m_b2_r.y * this->m_b2_apy.x - this->m_b2_r.x * this->m_b2_apy.y;
        zz.y = pos.y + zz.y;
        zz.z = pos.z + zz.z;
        zz.w = pos.w + zz.w;
        zz.z = zz.z + m_inv_mass;
        ...
        pos.z = -this->m_b2_r.x;
        pos.w = 0.0;
        v16 = phys_multiply((const phys_vec3 *)v27, v13, (phys_vec3 *)&pos.y);
        this->m_b2_apz.x = v16->x;
        this->m_b2_apz.y = v16->y;
        this->m_b2_apz.z = v16->z;
        pos.y = this->m_b2_apz.y * this->m_b2_r.z - this->m_b2_apz.z * this->m_b2_r.y;
        pos.z = this->m_b2_apz.z * this->m_b2_r.x - this->m_b2_apz.x * this->m_b2_r.z;
        pos.w = this->m_b2_r.y * this->m_b2_apz.x - this->m_b2_apz.y * this->m_b2_r.x;
        v29 = pos.y + v29;
        v30 = pos.z + v30;
        zx.w = pos.w + v31;
        v31 = zx.w + m_inv_mass;
    ...
    if ( is_spring )
    {
        pulse_sum_point::get_pos(this, (int)&v36, (const phys_vec3 *)v27);
        ...
        pos.z = v27[1] * zx.w;
        pos.w = zx.w * v27[2];
        this->m_right_side.x = pos.y;
        this->m_right_side.y = pos.z;
        this->m_right_side.z = pos.w;
        this->m_big_dirt.x = PHYS_ZERO_VEC_85.x;
        this->m_big_dirt.y = PHYS_ZERO_VEC_85.y;
        this->m_big_dirt.z = PHYS_ZERO_VEC_85.z;
    }
    else
    {
        v19 = 0.016666668;
        if ( delta_t > 0.016666668 )
            v19 = delta_t;
        m_inv_mass = v19;
        v20 = pulse_sum_point::get_pos(this, (int)&v36, (const phys_vec3 *)v27);
        zx.w = -0.5 / m_inv_mass;
        pos.y = zx.w * v20->x;
        pos.z = v20->y * zx.w;
        pos.w = zx.w * v20->z;
        this->m_big_dirt.x = pos.y;
        this->m_big_dirt.y = pos.z;
        this->m_big_dirt.z = pos.w;
        this->m_right_side.x = PHYS_ZERO_VEC_85.x;
        this->m_right_side.y = PHYS_ZERO_VEC_85.y;
        this->m_right_side.z = PHYS_ZERO_VEC_85.z;
        this->m_cfm = 0.0;
    }
    v21 = v31;
    z = zz.z;
    v23 = v30;
    pos.y = v31 * zz.z - v30 * zz.w;
    pos.z = zz.w * v29 - v31 * zz.y;
    v24 = v29;
    pos.w = zz.y * v30 - zz.z * v29;
    this->m_cr23.x = pos.y;
    this->m_cr23.y = pos.z;
    this->m_cr23.z = pos.w;
    ...
    this->m_cr31.y = pos.z;
    this->m_cr31.z = pos.w;
    pos.y = zz.w * zy.z - z * zy.w;
    pos.z = zy.w * zz.y - zz.w * y;
    pos.w = z * y - zy.z * zz.y;
    this->m_cr12.x = pos.y;
    this->m_cr12.y = pos.z;
    this->m_cr12.z = pos.w;
    ...
    this->m_denom.y = z;
    this->m_denom.z = v21;
    zx.w = v21 * this->m_cr12.z + v24 * this->m_cr12.x + v23 * this->m_cr12.y;
    zx.w = 1.0 / zx.w;
    v26 = zx.w;
    this->m_cr23.x = this->m_cr23.x * zx.w;
...
void __userpurge pulse_sum_point::SOLVER_solver_prolog(pulse_sum_point *this@<ecx>, int a2@<ebp>, float delta_t)
{
    ...
    v6[0] = a2;
    v6[1] = retaddr;
    vel = pulse_sum_point::get_vel(this, (int)v6, &v5);
    v4->m_right_side.x = v4->m_right_side.x - vel->x;
    v4->m_right_side.y = v4->m_right_side.y - vel->y;
    v4->m_right_side.z = v4->m_right_side.z - vel->z;
    v4->m_pulse_sum.x = v4->m_pulse_sum_cache->m_pulse_sum * delta_t;
    v4->m_pulse_sum.y = v4->m_pulse_sum_cache[1].m_pulse_sum * delta_t;
    v4->m_pulse_sum.z = delta_t * v4->m_pulse_sum_cache[2].m_pulse_sum;
    pulse_sum_point::apply(v4, &v4->m_pulse_sum);
}
...
void __thiscall pulse_sum_wheel::addp_pulse_chain(pulse_sum_wheel *this)
{
    ...
    if ( !pulse_sum_wheel::pulse_chain_within_limits(this) )
    {
        if ( _tlAssert(
...
void __thiscall pulse_sum_wheel::SOLVER_apply_relaxation(pulse_sum_wheel *this, float *error_sq)
{
    ...
    if ( m_side )
    {
        ...
        if ( this->m_fwd )
        {
            ...
            pulse_sum_wheel::addp_pulse_chain(this);
                ...
                float delta_t)
{
    ...
    phys_vec3 v8; // [esp-10h] [ebp-1Ch] BYREF
    unsigned int v9[3]; // [esp+0h] [ebp-Ch] BYREF
    _UNKNOWN *retaddr; // [esp+Ch] [ebp+0h]

    v9[0] = a2;
    v9[1] = retaddr;
    vel = pulse_sum_contact_point::get_vel(this, COERCE_FLOAT(v9), &v8, psc);
                ...
                float *error_sq)
{
    ...
    phys_vec3 denom; // [esp+0h] [ebp-30h] BYREF
    phys_vec3 m_objective; // [esp+10h] [ebp-20h]
    float v17; // [esp+20h] [ebp-10h]
    int v18; // [esp+24h] [ebp-Ch]
    void *v19; // [esp+28h] [ebp-8h]
    ...
    m_denom_zz = z;
    denom.x = w;
    objective = pulse_sum_contact_point::get_objective(this, &v11, psc);
    denom.y = objective->x - this->m_right_side.x;
    denom.z = objective->y - this->m_right_side.y;
    denom.w = objective->z - this->m_right_side.z;
    this->m_pulse_sum.x = this->m_pulse_sum.x - denom.y / this->m_denom_xx;
    if ( this->m_pulse_sum.x > 0.0 )
        this->m_pulse_sum.x = 0.0;
    v17 = this->m_pulse_sum.x - m_denom_xx;
    denom.z = this->m_denom_xy * v17 + denom.z;
    denom.w = v17 * this->m_denom_xz + denom.w;
    v9 = denom.w;
    v10 = denom.z;
    this->m_pulse_sum.y = this->m_pulse_sum.y - (this->m_inv_yz * denom.w + this->m_inv_yy * denom.z);
    this->m_pulse_sum.z = this->m_pulse_sum.z - (v10 * this->m_inv_yz + v9 * this->m_inv_zz);
    pulse_sum_contact_point::clamp_f(this, psc);
    denom.y = this->m_pulse_sum.x - m_denom_xx;
    denom.z = this->m_pulse_sum.y - y;
    denom.w = this->m_pulse_sum.z - m_denom_zz;
    pulse_sum_contact_point::apply(this, psc, (phys_vec3 *)&denom.y);
    m_denom_xx = this->m_denom_xx;
    y = this->m_denom_yy;
    m_denom_zz = this->m_denom_zz;
    m_objective.z = m_denom_zz * denom.w;
    m_objective.w = y * denom.z;
    v17 = m_denom_xx * denom.y;
    m_denom_xx = v17 * v17;
    y = m_objective.w * m_objective.w;
    m_denom_zz = m_objective.z * m_objective.z;
                ...
                float min_restitution_impact_vel_sq)
{
    ...
    {
        v8->m_right_side.x = PHYS_ZERO_VEC_85.x;
        v8->m_right_side.y = PHYS_ZERO_VEC_85.y;
        v8->m_right_side.z = PHYS_ZERO_VEC_85.z;
    }
    else
    {
...
pulse_sum_constraint_solver *__thiscall pulse_sum_constraint_solver::pulse_sum_constraint_solver(
                pulse_sum_constraint_solver *this)
{
    pulse_sum_constraint_solver *result; // eax
                ...
                rigid_body *const head)
{
    ...
    {
        rbint::euler_integrate_velocity(COERCE_FLOAT(&savedregs), j->m_rb, this->m_si.m_delta_t);
        j->t_vel.x = PHYS_ZERO_VEC_85.x;
        j->t_vel.y = PHYS_ZERO_VEC_85.y;
        j->t_vel.z = PHYS_ZERO_VEC_85.z;
        j->a_vel.x = PHYS_ZERO_VEC_85.x;
        j->a_vel.y = PHYS_ZERO_VEC_85.y;
        j->a_vel.z = PHYS_ZERO_VEC_85.z;
    }
    ...
    pulse_sum_constraint_solver::solve_iterative(this, this->m_si.m_max_vel_iters, this->m_si.m_max_vel_error_sq);
    ...
    pulse_sum_constraint_solver::solve_iterative(this, this->m_si.m_max_vel_pos_iters, this->m_si.m_max_vel_pos_error_sq);
    ...
    for ( i12 = 1; m_first; m_first = m_first->m_next_link )
    {
        ...
        rbint::euler_integrate_pos((int)&savedregs, m_first->m_rb, this->m_si.m_delta_t);
    ...
    *(float *)&v64 = (float)sub_steps;
    ...
    if ( v22 > 0 )
    {
        ...
        do
        {
            ...
            do
            {
                v26 = (pulse_sum_node *)phys_transient_allocator::allocate(
                                                                    p_m_solver_memory_allocator,
                                                                    128,
                                                                    16,
                                                                    0,
                                                                    SOLVER_MEMORY_ALLOCATOR_ERROR_MSG);
            ...
            pulse_sum_constraint_solver::solve_constraints(this, head);
    ...
    do
    {
        v62->m_force_sum.x = PHYS_ZERO_VEC_85.x;
        v62->m_force_sum.y = PHYS_ZERO_VEC_85.y;
        v62->m_force_sum.z = PHYS_ZERO_VEC_85.z;
        v62->m_torque_sum.x = PHYS_ZERO_VEC_85.x;
        v62->m_torque_sum.y = PHYS_ZERO_VEC_85.y;
        v62->m_torque_sum.z = PHYS_ZERO_VEC_85.z;
