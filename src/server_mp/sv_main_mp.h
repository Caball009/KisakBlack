...
{                                       // XREF: .data:serverStatic_t svs/r
    ...
    MatchState *snapshotMatchStates;    // XREF: SV_AllocateClientMemory(HunkUser *,int,int)+6B/w
...
{                                       // XREF: .data:serverStaticHeader_t svsHeader/r
    ...
    svEntity_s *svEntities;             // XREF: SV_ArchiveSnapshot(msg_t *)+7B9/r
...
{                                       // XREF: .data:server_t sv/r
    ...
    unsigned __int16 configstrings[3228];
                                        // XREF: SV_SendClientGameState(client_t *)+50D/r
                                        // SV_SendClientGameState(client_t *)+642/r ...
    // padding byte
    // padding byte
